...
$(document).ready(function() {
	...
	$(add_button).click(function(e){
		...
		if(window.screen.width > 768) { 
			add++; 
			$(ingredient_wrapper).append('<div class="row ingredients"><div class="col-1"><p id="ing-number"><i class="fas fa-haykal"></i></p></div><div class="ingredient-field col-md-5 food-field"><input id="food" name="food" type="text" class="form-control validate" minlength ="1" maxlength="30" pattern="^[a-zA-Z0-9 -]{1,30}$" placeholder="Food" required></div><div class="ingredient-field col-sm-1 input_ing_wrap"><input id="count" name="count" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control no-spinner validate" minlength="0" maxlength="4" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" placeholder="Quantity"></div><div class="ingredient-field col-lg-2 size-field input_ing_wrap"><input id="size" name="size" type="text" class="form-control validate" maxlength="20" pattern="^[a-zA-Z0-9 -]{0,20}$" placeholder="Size"></div><div class="ingredient-field col-sm-1 input_ing_wrap"><input id="weight" name="weight" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control no-spinner validate" minlength="0" maxlength="4" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" placeholder="Weight"></div><div class="ingredient-field col-sm-1 input_ing_wrap"><input id="volume" name="volume" type="number" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control no-spinner validate" minlength="0" maxlength="4" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" placeholder="Volume"></div><div class="ingredient-field col-sm-1 center-align"><a href="#" class="remove_field"><i class="fas fa-trash-alt"></i></a></div></div></div>');
		}
